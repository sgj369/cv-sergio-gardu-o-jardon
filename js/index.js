...
const translations = {
  en: {
    ...
    'ecogaias-btn': '🌐 Visit Eco Gaia SOS',
  ...
  es: {
    ...
    'carta-p3': 'Más allá de lo técnico, le apasiona conocer más sobre flora y fauna, además de conectar con actores por medio del proyecto <strong>ECOGAIASOS</strong> que generan acciones en pro del planeta y participar activamente en eventos de limpieza o restauración de hábitats. Sergio cree firmemente que la acción combinada con el conocimiento adecuado siempre tendrá un mejor resultado.',
  },
};
